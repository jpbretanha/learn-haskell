...
/* package aula-haskell-0.1.0.0 */
#ifndef VERSION_aula_haskell
#define VERSION_aula_haskell "0.1.0.0"
#endif /* VERSION_aula_haskell */
#ifndef MIN_VERSION_aula_haskell
#define MIN_VERSION_aula_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_aula_haskell */
...
#define CURRENT_COMPONENT_ID "aula-haskell-0.1.0.0-GBg532cd6ShArGxtk90Fl6-aula-haskell"
